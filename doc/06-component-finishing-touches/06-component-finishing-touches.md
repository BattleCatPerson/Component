...
I do not really understand that much better since this was created mainly using the same OSU component principles.
> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

It did not. I followed the instructions and was able to accomplish the tasks given.
> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

My perspective has not changed much. I still enjoy and dislike software development as much as I used to. This whole project did not feel like it opened a whole new world or anything like that.
...
I was able to learn how to reach out to people for help.
...
This has not affected my career trajectory because it was not really related to it in the first place.
...
I should probably work on more video games if I want to make it in the industry to have more portfolio work. I can contact some old game development instructors I used to learn from.
